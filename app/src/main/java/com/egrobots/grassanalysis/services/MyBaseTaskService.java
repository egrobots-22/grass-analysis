...
//        if (caption.equals(getString(R.string.progress_uploading))) {
//            double progress = (100.0 * completedUnits / totalUnits);
//            caption = getString(R.string.uploaded) + (int) progress + "%";
//        }
